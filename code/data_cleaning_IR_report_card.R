...
setwd("./data_sources")
math_prof <- read_excel("raw_data/2025-Report-Card-Public-Data-Set.xlsx", sheet = "ELAMathScience")
colnames(math_prof)
...
science_prof <- read_excel("raw_data/2025-Report-Card-Public-Data-Set.xlsx", sheet = "ELAMathScience (2)")
...
write_xlsx(math_and_science_prof, "output/report_card_proficiency_scores.xlsx")
